...
class ContentViewModel(private val repository: UserRepository) : ViewModel() {
...
class ContentViewModelFactory(private val repository: UserRepository) : ViewModelProvider.Factory {
