...
import com.nfach98.githubuserfavoritefavorite.databinding.FragmentDetailFollowBinding
                ...
                0 -> {
                    viewModel.getUserFollower(username).observe(viewLifecycleOwner, {
                        if(it != null){
                            ...
                            adapter.setOnItemClickCallback(object : DetailAdapter.OnItemActionCallback {
